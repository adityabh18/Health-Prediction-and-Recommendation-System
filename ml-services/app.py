...
# =============================================
# 2. LAZY MODEL LOADING FUNCTIONS
# =============================================
...
def load_kidney_model():
    ...
    global kidney_imputer
    global kidney_model

    if kidney_imputer is None:
    ...
    if kidney_model is None:
        ...
        if (
            hasattr(kidney_imputer, "_fit_dtype")
            and not hasattr(kidney_imputer, "_fill_dtype")
        ):
